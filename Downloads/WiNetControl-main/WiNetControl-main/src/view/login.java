...
public class login extends javax.swing.JFrame {
    ...
    if (identificacion.equals("admin") && contrasena.equals("admin")) {
        loginExitoso = true;
    ...
    // Buscar si el usuario existe pero la contraseña es incorrecta
    boolean usuarioEncontrado = false;
    for (int i = 0; i < contadorClientes; i++) {
        if (clientes[i] != null && clientes[i].getIdentificacion().equals(identificacion)) {
            usuarioEncontrado = true;
            if (clientes[i].getContrasena().equals(contrasena)) {
                loginExitoso = true;
    ...
    if (!loginExitoso) {
        if (usuarioEncontrado) {
            JOptionPane.showMessageDialog(this, "Contraseña incorrecta. Por favor intente de nuevo.",
                    "Error de acceso", JOptionPane.ERROR_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(this, "Datos incorrectos. Usuario no encontrado.",
                    "Error de acceso", JOptionPane.ERROR_MESSAGE);
        }
    }
